...
sbatch --time 24:00:00 --partition cpu --job-name="md5" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-5 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-05/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-5.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md10" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-10 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-10/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-10.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md15" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-15 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-15/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-15.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md20" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-20 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-20/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-20.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md25" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-25 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-25/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-25.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md50" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-50 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-50/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-50.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md75" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-75 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-75/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-75.$(date +%Y%m%d).out.txt"

sbatch --time 24:00:00 --partition cpu --job-name="md100" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="singularity run --bind /scratch/prj/sgdp_nanopore/Projects/prada_jz ~/project/prada_jz/venv/mosdepth_c2.sif -t 6 --by /scratch/prj/sgdp_nanopore/Projects/prada_jz/data/bed/pgx_cnv.grch38.5k.2p1percent.bed --fast-mode multi-hg002-100 /scratch/prj/sgdp_nanopore/Projects/prada_jz/work/pgx/downsampled-bam-runs/test-2/wf-pgx/no-bed/hg002-100/output/HG002_new_hg19_merged/HG002_new_hg19_merged.haplotagged.bam" --output "mdepth.multi-hg002-100.$(date +%Y%m%d).out.txt"
...
fixing the regions for pilot3

```{r}

library(data.table)

d<-fread("/Users/jakz/Documents/work_rstudio/prada/data/applicationCoverageRegionsAsOfPilot2.tsv")
d2<-d[type!=2,]
fwrite(x = d2,file = "/Users/jakz/Documents/work_rstudio/prada/data/roughApplicationCoverageRegionsAsOfPilot3.tsv")
