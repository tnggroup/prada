...
sbatch --time 1:00:00 --partition cpu --job-name="pap3" --ntasks 1 --cpus-per-task 6 --mem 16G --wrap="Rscript /scratch/prj/sgdp_nanopore/Projects/prada_jz/src-r/pradaAppPilot3.R" --output "pradaAppPilot3.$(date +%Y%m%d).out.txt"
