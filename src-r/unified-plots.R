...
ggplot(sampleMetaTot,aes(x = sdepth_q050_bed, y = nvarq_region, colour = analysis)) +
  geom_point() +
...
ggplot(sampleMetaTot,aes(x = sdepth_q050_bed, y = vcallacc_q050_region, colour = analysis)) +
  geom_point() +
...
ggplot(sampleMetaTot,aes(x = sdepth_q050_bed, y = meanPgxVariantRatio, colour = analysis)) +
  geom_point() +
...
ggplot(sampleMetaTot,aes(x = sdepth_q050_bed, y = nCalledPgx, colour = analysis)) +
  geom_point() +
...
ggplot(sampleMetaTot,aes(x = sdepth_q050_nobed, y = nvarq_noregion, colour = analysis)) +
  geom_point() +
...
ggplot(sampleMetaTot,aes(x = sdepth_q050_nobed, y = vcallacc_q050_noregion, colour = analysis)) +
  geom_point() +
